...
export default function Profile() {
  ...
  async function upload1(file: any, user: any) {
    try {
      ...
      deleteObject(pictureRef).then(() => console.log("deleted"));
      setLoading(true);
        ...
        <div className="profile_main">
          <div className="inside_profile">
            ...
            <div className="email">
              ...
              <Typography className="email_ac" variant="h6">
                {user.email}
              </Typography>
            </div>
            <label htmlFor="files" className="btn1">
